...
int evaluate(Mat img,bool debug,int frame){
	...
	Mat label_img = imread("/home/tejus/Documents/vision/lane-detector/labeller/sequence_2/"+label_name);
    cout<<"/home/tejus/Documents/vision/lane-detector/labeller/sequence_2/"+label_name<<endl;
...
int main()
{
    ...
    // detect_lanes(img);
 //    eval_file.open("error4.txt");
	// int total_frame=0;

 //    for(int i=90;i<=836;i++)
 //    {
 //    	total_frame++;
 //        cout<<i<<endl;
 //        image_name = string(10-int_to_string(i).length(),'0')+int_to_string(i)+".png";
 ...
 //    }
    ...
    out.open( "outputVideo4.avi", CV_FOURCC('D','I','V','X'), 10, Size ( 1242, 375), true );
